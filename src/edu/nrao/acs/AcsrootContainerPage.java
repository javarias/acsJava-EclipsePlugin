...
public class AcsrootContainerPage extends WizardPage implements
...
//        }
        IPath containerPath = AcsrootContainer.ID.append( "/" + dir + "/" + 
                                                                   getExtValue());
    ...
    private String getInitDir() {
        ...
        String acsrootDir =  System.getenv("ACSROOT");
        ...
        if (acsrootDir == null)
        	return projDir;
        return acsrootDir.substring(0, acsrootDir.lastIndexOf(IPath.SEPARATOR));
    }
